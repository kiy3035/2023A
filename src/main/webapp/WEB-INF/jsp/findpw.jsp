                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.result == "0") {
                                ...
                                location.href = "${pageContext.request.contextPath}/changePwForm?userid=" + result.result;
                            }
                        },
                    })
                }
		...
		<div class="w3-container w3-card-4 w3-auto" style="width: 382px;height: 456.3px;">
			...
			<div>
				...
				<p class="w3-center">
					...
					<button type="button" onclick="history.go(-1);" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">로그인 화면</button>
				</p>
			</div>
		</div>
	</div>
